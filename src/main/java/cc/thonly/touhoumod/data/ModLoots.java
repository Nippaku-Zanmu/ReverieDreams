...
import cc.thonly.touhoumod.entity.Yousei;
...
public class ModLoots {
    public static void register() {
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            if (source.isBuiltin() && key.equals(LootTables.ABANDONED_MINESHAFT_CHEST)) {
        ...
        ServerLivingEntityEvents.AFTER_DEATH.register(ModLoots::modifyDrops);
    }
    ...
    private static void dropPointPower(LivingEntity entity, DamageSource damageSource) {
        ...
        if((entity instanceof HostileEntity || entity instanceof Yousei) && world instanceof ServerWorld serverWorld) {
