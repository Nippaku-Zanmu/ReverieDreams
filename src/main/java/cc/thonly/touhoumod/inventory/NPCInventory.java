...
import cc.thonly.touhoumod.gui.NPCGui;
...
public class NPCInventory extends SimpleInventory {
    ...
    public static final Integer CHEST_INDEX = NPCGui.size() - 5;
    public static final Integer LEGS_INDEX = NPCGui.size() - 4;
    public static final Integer FEET_INDEX = NPCGui.size() - 3;
