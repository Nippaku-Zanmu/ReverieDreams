package cc.thonly.touhoumod.gui.server;

import cc.thonly.touhoumod.gui.recipe.GuiOpeningPrevCallback;
import cc.thonly.touhoumod.gui.recipe.GuiStackGetter;
...
public class BasePageGui extends SimpleGui {
    ...
    public void init() {
        this.setTitle(Text.empty().append(this.recipeGuiInfo.getId().toTranslationKey()).append(Text.of(" (" + (this.page + 1) + "/" + (getMaxPage() + 1) + ")")));
