...
public class TripleTrajectory extends DanmakuTrajectory {
    ...
    public void run(ServerWorld world, @Nullable LivingEntity livingEntity, ItemStack stack, Double x, Double y, Double z, float pitch, float yaw, float speed, float acceleration, float divergence, float offsetDist, DanmakuItemType pThis) {
        DanmakuTrajectory.spawnByItemStack(world, livingEntity, x, y, z, stack, pitch, yaw - 15.0f, 1.4f, acceleration, 5.0f, 0f);
        DanmakuTrajectory.spawnByItemStack(world, livingEntity, x, y, z, stack, pitch, yaw, 1.4f, acceleration, 5.0f, 0f);
        DanmakuTrajectory.spawnByItemStack(world, livingEntity, x, y, z, stack, pitch, yaw + 15.0f, 1.4f, acceleration, 5.0f, 0f);
    }
}
