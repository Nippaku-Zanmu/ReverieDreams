...
public class GensokyoAltarDisplayView extends SimpleGui implements DisplayView {
    ...
    public GensokyoAltarDisplayView(ServerPlayerEntity player, RecipeEntryWrapper<GensokyoAltarRecipe> key2ValueEntry, GuiOpeningPrevCallback prevGuiCallback) {
