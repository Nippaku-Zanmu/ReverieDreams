...
@Getter
public class BasicPolymerWallHangingSignBlock extends WallHangingSignBlock implements FactoryBlock, IdentifierGetter {
    private final Identifier identifier;
    private final Block template = Blocks.MANGROVE_WALL_HANGING_SIGN;

    public BasicPolymerWallHangingSignBlock(Identifier identifier, WoodType woodType, Settings settings) {
        super(woodType, settings.registryKey(RegistryKey.of(RegistryKeys.BLOCK, identifier)));
        this.identifier = identifier;
    }

    public BasicPolymerWallHangingSignBlock(String path, WoodType woodType, Settings settings) {
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        return new BasicPolymerWallHangingSignBlock.Model(initialBlockState, this.getIdentifier());
    }
