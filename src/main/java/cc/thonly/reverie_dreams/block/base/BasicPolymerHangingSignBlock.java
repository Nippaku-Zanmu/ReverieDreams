...
@Getter
public class BasicPolymerHangingSignBlock extends HangingSignBlock implements FactoryBlock, IdentifierGetter {
    private final Identifier identifier;
    private final Block template = Blocks.MANGROVE_HANGING_SIGN;

    public BasicPolymerHangingSignBlock(Identifier identifier, WoodType woodType, Settings settings) {
        super(woodType, settings.registryKey(RegistryKey.of(RegistryKeys.BLOCK, identifier)));
        this.identifier = identifier;
    }

    public BasicPolymerHangingSignBlock(String path, WoodType woodType, Settings settings) {
    ...
    public @Nullable ElementHolder createElementHolder(ServerWorld world, BlockPos pos, BlockState initialBlockState) {
        return new BasicPolymerHangingSignBlock.Model(initialBlockState, this.getIdentifier());
    }
